...
/**
 * @Author czx
 * @Description //TODO 定制token 存储
 * @Date 15:29 2019/7/11
 * @Param
 * @return
 **/
public class CustomRedisTokenStore implements TokenStore {
	...
	private static final boolean springDataRedis_2_0 = ClassUtils.isPresent("org.springframework.data.redis.connection.RedisStandaloneConfiguration",
			CustomRedisTokenStore.class.getClassLoader());
	...
	public void removeAccessToken(String tokenValue) {
		...
		byte[] authUserKey = serializeKey(AUTH_USER + tokenValue);
